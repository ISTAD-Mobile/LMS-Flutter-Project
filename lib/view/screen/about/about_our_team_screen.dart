                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          GestureDetector(
                            onTap: () => launchUrl(Uri.parse('https://www.facebook.com/share/1FsVPhT9fq/')),
                          ...
                          GestureDetector(
                            onTap: () => launchUrl(Uri.parse('https://github.com/LeanNaikim')),
                            child: SvgPicture.string(
                          ...
                          const SizedBox(width: 10),
                          GestureDetector(
                            onTap: () => launchUrl(Uri.parse('https://t.me/Nai_kimm')),
                            child: SvgPicture.string(
                              '''<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 256 256">
                                <defs>
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          GestureDetector(
                            onTap: () => launchUrl(Uri.parse('https://www.facebook.com/noun.sovannthon/')),
                            child: SvgPicture.string(
                              '''<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 256 256">
                                    <path fill="#1877f2" d="M256 128C256 57.308 198.692 0 128 0S0 57.308 0 128c0 63.888 46.808 116.843 108 126.445V165H75.5v-37H108V99.8c0-32.08 19.11-49.8 48.348-49.8C170.352 50 185 52.5 185 52.5V84h-16.14C152.959 84 148 93.867 148 103.99V128h35.5l-5.675 37H148v89.445c61.192-9.602 108-62.556 108-126.445" />
                                    <path fill="#fff" d="m177.825 165l5.675-37H148v-24.01C148 93.866 152.959 84 168.86 84H185V52.5S170.352 50 156.347 50C127.11 50 108 67.72 108 99.8V128H75.5v37H108v89.445A129 129 0 0 0 128 256a129 129 0 0 0 20-1.555V165z" />
                          ...
                          const SizedBox(width: 10),
                          GestureDetector(
                            onTap: () => launchUrl(Uri.parse('https://github.com/sovanthorn')),
                            child: SvgPicture.string(
                              '''<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 64 64">
                                  <path fill="currentColor" d="M32 0C14 0 0 14 0 32c0 21 19 30 22 30c2 0 2-1 2-2v-5c-7 2-10-2-11-5c0 0 0-1-2-3c-1-1-5-3-1-3c3 0 5 4 5 4c3 4 7 3 9 2c0-2 2-4 2-4c-8-1-14-4-14-15q0-6 3-9s-2-4 0-9c0 0 5 0 9 4c3-2 13-2 16 0c4-4 9-4 9-4c2 7 0 9 0 9q3 3 3 9c0 11-7 14-14 15c1 1 2 3 2 6v8c0 1 0 2 2 2c3 0 22-9 22-30C64 14 50 0 32 0" />
                                </svg>''',
                          ...
                          const SizedBox(width: 10),
                          GestureDetector(
                            onTap: () => launchUrl(Uri.parse('https://t.me/S0van6')),
                            child: SvgPicture.string(
                              '''<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 256 256">
                              <defs>
                                <linearGradient id="logosTelegram0" x1="50%" x2="50%" y1="0%" y2="100%">
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          GestureDetector(
                            onTap: () => launchUrl(Uri.parse('https://www.facebook.com/sothibheng/')),
                            child: SvgPicture.string(
                              '''<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 256 256">
                                  <path fill="#1877f2" d="M256 128C256 57.308 198.692 0 128 0S0 57.308 0 128c0 63.888 46.808 116.843 108 126.445V165H75.5v-37H108V99.8c0-32.08 19.11-49.8 48.348-49.8C170.352 50 185 52.5 185 52.5V84h-16.14C152.959 84 148 93.867 148 103.99V128h35.5l-5.675 37H148v89.445c61.192-9.602 108-62.556 108-126.445" />
                                  <path fill="#fff" d="m177.825 165l5.675-37H148v-24.01C148 93.866 152.959 84 168.86 84H185V52.5S170.352 50 156.347 50C127.11 50 108 67.72 108 99.8V128H75.5v37H108v89.445A129 129 0 0 0 128 256a129 129 0 0 0 20-1.555V165z" />
                          ...
                          const SizedBox(width: 10),
                          GestureDetector(
                            onTap: () => launchUrl(Uri.parse('https://github.com/SothibHeng')),
                            child: SvgPicture.string(
                              '''<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 64 64">
                                    <path fill="currentColor" d="M32 0C14 0 0 14 0 32c0 21 19 30 22 30c2 0 2-1 2-2v-5c-7 2-10-2-11-5c0 0 0-1-2-3c-1-1-5-3-1-3c3 0 5 4 5 4c3 4 7 3 9 2c0-2 2-4 2-4c-8-1-14-4-14-15q0-6 3-9s-2-4 0-9c0 0 5 0 9 4c3-2 13-2 16 0c4-4 9-4 9-4c2 7 0 9 0 9q3 3 3 9c0 11-7 14-14 15c1 1 2 3 2 6v8c0 1 0 2 2 2c3 0 22-9 22-30C64 14 50 0 32 0" />
                                  </svg>''',
                          ...
                          const SizedBox(width: 10),
                          GestureDetector(
                            onTap: () => launchUrl(Uri.parse('https://t.me/sothibHeng')),
                            child: SvgPicture.string(
                              '''<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 256 256">
                                <defs>
                                  <linearGradient id="logosTelegram0" x1="50%" x2="50%" y1="0%" y2="100%">
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          GestureDetector(
                            onTap: () => launchUrl(Uri.parse('https://www.facebook.com/share/15zMZRUKqU/')),
                            child: SvgPicture.string(
                              '''<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 256 256">
                                  <path fill="#1877f2" d="M256 128C256 57.308 198.692 0 128 0S0 57.308 0 128c0 63.888 46.808 116.843 108 126.445V165H75.5v-37H108V99.8c0-32.08 19.11-49.8 48.348-49.8C170.352 50 185 52.5 185 52.5V84h-16.14C152.959 84 148 93.867 148 103.99V128h35.5l-5.675 37H148v89.445c61.192-9.602 108-62.556 108-126.445" />
                                  <path fill="#fff" d="m177.825 165l5.675-37H148v-24.01C148 93.866 152.959 84 168.86 84H185V52.5S170.352 50 156.347 50C127.11 50 108 67.72 108 99.8V128H75.5v37H108v89.445A129 129 0 0 0 128 256a129 129 0 0 0 20-1.555V165z" />
                          ...
                          const SizedBox(width: 10),
                          GestureDetector(
                            onTap: () => launchUrl(Uri.parse('https://github.com/nhoemtevy')),
                            child: SvgPicture.string(
                              '''<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 64 64">
                                    <path fill="currentColor" d="M32 0C14 0 0 14 0 32c0 21 19 30 22 30c2 0 2-1 2-2v-5c-7 2-10-2-11-5c0 0 0-1-2-3c-1-1-5-3-1-3c3 0 5 4 5 4c3 4 7 3 9 2c0-2 2-4 2-4c-8-1-14-4-14-15q0-6 3-9s-2-4 0-9c0 0 5 0 9 4c3-2 13-2 16 0c4-4 9-4 9-4c2 7 0 9 0 9q3 3 3 9c0 11-7 14-14 15c1 1 2 3 2 6v8c0 1 0 2 2 2c3 0 22-9 22-30C64 14 50 0 32 0" />
                                  </svg>''',
                          ...
                          const SizedBox(width: 10),
                          GestureDetector(
                            onTap: () => launchUrl(Uri.parse('https://t.me/tevy_nhoem')),
                            child: SvgPicture.string(
                              '''<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 256 256">
                                <defs>
                                  <linearGradient id="logosTelegram0" x1="50%" x2="50%" y1="0%" y2="100%">
