                      ...
                      if (emailOrUsername.isNotEmpty && password.isNotEmpty) {
                        ...
                        if (viewModel.accessToken != null) {
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => StudentScreen(accessToken: viewModel.accessToken!, title: '',),
                            ),
                          );
                        } else {
                          // Display an error if no access token was received
                          print("Error: ${viewModel.errorMessage}");
                        }
                      } else {
                        print("Please enter both email/username and password.");
                      }
                    },
                    child: Container(
                      height: 50,
