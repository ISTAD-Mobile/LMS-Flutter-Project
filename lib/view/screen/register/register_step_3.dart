            ...
            child: Column(
              ...
              children: [
                ...
                _buildDropdownField(
                  ...
                  validator: (value) {
                    if (value == null || value.isEmpty || value == 'Select Shift') {
                      return 'This field is required';
                    }
                    return null;
                  },
                ...
                _buildDropdownField(
                  ...
                  validator: (value) {
                    if (value == null || value.isEmpty || value == 'Select Degree') {
                      return 'This field is required';
                    }
                    return null;
                  },
                ...
                _buildDropdownField(
                  ...
                  onChanged: (value) {
                    setState(() {
                      selectedCurrentAddress = value;
                    });
                  },
                  validator: (value) {
                    if (value == null || value.isEmpty || value == 'Select Study Program') {
                      return 'This field is required';
                    }
                    return null;
                  },
